        ...
        <div className="py-6 md:py-0 md:px-6">
          ...
          <div className="space-y-4">
            ...
            <p className="flex items-center">
              ...
              <span>ruth@tenderscan.co.za</span>
            </p>
          </div>
        </div>
        <form className="flex flex-col py-6 space-y-6 md:py-0 md:px-6 ng-untouched ng-pristine ng-valid">
          <label className="block">
            ...
            <input
              ...
              className="block w-full rounded-md shadow-sm focus:ring focus:ring-opacity-75 focus:ring-green-400 dark:bg-coolGray-800"
            />
          </label>
          <label className="block">
          ...
          <button
            type="button"
            className="self-center px-8 py-3 text-lg rounded focus:ring hover:ring focus:ring-opacity-75 bg-green-400 dark:text-coolGray-900 focus:ring-green-400 hover:ring-green-400"
          >
            Submit
          </button>
        </form>
